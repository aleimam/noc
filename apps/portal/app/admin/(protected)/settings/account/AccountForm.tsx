  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3 rounded-lg border border-graphite/15 p-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="text-sm">{t('currentPassword')}<input type="password" value={cur} onChange={(e) => setCur(e.target.value)} dir="ltr" className={inp} /></label>
          <label className="text-sm">{t('newPassword')}<input type="password" value={next} onChange={(e) => setNext(e.target.value)} dir="ltr" className={inp} /></label>
        </div>
        <div className="flex items-center gap-3">
