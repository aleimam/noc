...
export function StoreMobileMenu({
  ...
  return (
    <>
      <button type="button" onClick={() => setOpen(true)} aria-label={L('القائمة', 'Menu')} className="rounded-lg p-2.5 text-white hover:bg-white/10 lg:hidden">
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex flex-col bg-navy-800 text-soft lg:hidden">
